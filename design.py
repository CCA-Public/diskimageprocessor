...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">General options (processing)</span></p></body></html>", None))
        ...
        self.label_5.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">File export options (processing)</span></p></body></html>", None))
        self.checkBox_2.setText(_translate("MainWindow", "tsk_recover: Export all files (not only allocated)", None))
